...
from embscenedetect.costs import calcCostsHex
from embscenedetect.distances import calcDistancesWindowed, calcDistancesWindowedShifted, normalizeDistances
...
(sums, areas) = calcCostsHex(distances=distances, distancesShifted=distancesShifted, 
                            minSplit = 1, maxSplit = 32, splitRate = 0.5, fullArea=True)
